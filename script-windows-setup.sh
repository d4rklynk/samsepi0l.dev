...
echo 'auhtors: TommyTran732' >> './content/blog/cybersec/windows-setup/general-tips/index.md'
...
echo 'auhtors: TommyTran732' >> './content/blog/cybersec/windows-setup/debloat/index.md'
...
echo 'auhtors: TommyTran732' >> './content/blog/cybersec/windows-setup/group-policies/index.md'
...
sed -i 's/# Printers/### Printers/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Start Menu and Taskbar/### Start Menu and Taskbar/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# User Account Control/### User Account Control/' './content/blog/cybersec/windows-setup/group-policies/index.md'

echo '## Control Panel' >> './content/blog/cybersec/windows-setup/group-policies/index.md'
...
sed -i 's/# Allow Online Tips/### Allow Online Tips/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Personalization/### Personalization/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Regional and Language Options/### Regional and Language Options/' './content/blog/cybersec/windows-setup/group-policies/index.md'

echo '## System' >> './content/blog/cybersec/windows-setup/group-policies/index.md'
...
sed -i 's/# Credentials Delegation/### Credentials Delegation/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Device Guard/### Device Guard/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Device Health Attestation Service/### Device Health Attestation Service/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Early Launch Antimalware/### Early Launch Antimalware/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Internet Communication settings/### Internet Communication settings/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Kernel DMA Protection/### Kernel DMA Protection/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Mitigation Options/### Mitigation Options/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# OS Policies/### OS Policies/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Remote Assistance/### Remote Assistance/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Service Control Manager Settings/###Service Control Manager Settings/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# User Profiles/### User Profiles/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Windows Time Service/### Windows Time Service/' './content/blog/cybersec/windows-setup/group-policies/index.md'
...
sed -i 's/# App Privacy/### App Privacy/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Application Compatibility/### Application Compatibility/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# AutoPlay Policies/### AutoPlay Policies/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Bitlocker Drive Encryption/### Bitlocker Drive Encryption/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Cloud Content/### Cloud Content/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Controlled Folder Access/### Controlled Folder Access/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Controlled Folder Access/### Controlled Folder Access/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# File Explorer/### File Explorer/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Find My Device/### Find My Device/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Location and Sensors/### Location and Sensors/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# MAPS/### MAPS/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# MDM/### MDM/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Messaging/### Messaging/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Legacy Microsoft Edge/### Legacy Microsoft Edge/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Microsoft account/### Microsoft account/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Network Protection/### Network Protection/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Search/### Search/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Software Protection Platform/### Software Protection Platform/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Sync your settings/### Sync your settings/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Text Input/### Text Input/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Widgets/### Widgets/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Windows Calendar/### Windows Calendar/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Windows Defender SmartScreen/### Windows Defender SmartScreen/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Windows Error Reporting/### Windows Error Reporting/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Windows Game Recording and Broadcasting/### Windows Game Recording and Broadcasting/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Windows Media Digital Rights Management/### Windows Media Digital Rights Management/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Windows Calendar/### Windows Calendar/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Windows Update/### Windows Update/' './content/blog/cybersec/windows-setup/group-policies/index.md'
...
sed -i 's/# Cloud Content/### Cloud Content/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# File Explorer/### File Explorer/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Windows Copilot/### Windows Copilot/' './content/blog/cybersec/windows-setup/group-policies/index.md'
...
echo 'auhtors: TommyTran732' >> './content/blog/cybersec/windows-setup/windows-settings/index.md'
