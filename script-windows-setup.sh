...
echo 'authors: TommyTran732' >> './content/blog/cybersec/windows-setup/general-tips/index.md'
...
echo 'authors: TommyTran732' >> './content/blog/cybersec/windows-setup/debloat/index.md'
...
echo 'authors: TommyTran732' >> './content/blog/cybersec/windows-setup/group-policies/index.md'
...
sed -i 's/# Printers/\r### Printers/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Start Menu and Taskbar/\r### Start Menu and Taskbar/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# User Account Control/\r### User Account Control/' './content/blog/cybersec/windows-setup/group-policies/index.md'

echo '\r## Control Panel' >> './content/blog/cybersec/windows-setup/group-policies/index.md'
...
sed -i 's/# Allow Online Tips/\r### Allow Online Tips/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Personalization/\r### Personalization/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Regional and Language Options/\r### Regional and Language Options/' './content/blog/cybersec/windows-setup/group-policies/index.md'

echo '\r## System' >> './content/blog/cybersec/windows-setup/group-policies/index.md'
...
sed -i 's/# Credentials Delegation/\r### Credentials Delegation/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Device Guard/\r### Device Guard/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Device Health Attestation Service/\r### Device Health Attestation Service/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Early Launch Antimalware/\r### Early Launch Antimalware/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Internet Communication settings/\r### Internet Communication settings/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Kernel DMA Protection/\r### Kernel DMA Protection/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Mitigation Options/\r### Mitigation Options/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# OS Policies/\r### OS Policies/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Remote Assistance/\r### Remote Assistance/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Service Control Manager Settings/\r###Service Control Manager Settings/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# User Profiles/\r### User Profiles/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Windows Time Service/\r### Windows Time Service/' './content/blog/cybersec/windows-setup/group-policies/index.md'
...
sed -i 's/# App Privacy/\r### App Privacy/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Application Compatibility/\r### Application Compatibility/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# AutoPlay Policies/\r### AutoPlay Policies/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Bitlocker Drive Encryption/\r### Bitlocker Drive Encryption/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Cloud Content/\r### Cloud Content/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Controlled Folder Access/\r### Controlled Folder Access/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Controlled Folder Access/\r### Controlled Folder Access/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# File Explorer/\r### File Explorer/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Find My Device/\r### Find My Device/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Location and Sensors/\r### Location and Sensors/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# MAPS/\r### MAPS/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# MDM/\r### MDM/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Messaging/\r### Messaging/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Legacy Microsoft Edge/\r### Legacy Microsoft Edge/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Microsoft account/\r### Microsoft account/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Network Protection/\r### Network Protection/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Search/\r### Search/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Software Protection Platform/\r### Software Protection Platform/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Sync your settings/\r### Sync your settings/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Text Input/\r### Text Input/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Widgets/\r### Widgets/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Windows Calendar/\r### Windows Calendar/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Windows Defender SmartScreen/\r### Windows Defender SmartScreen/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Windows Error Reporting/\r### Windows Error Reporting/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Windows Game Recording and Broadcasting/\r### Windows Game Recording and Broadcasting/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Windows Media Digital Rights Management/\r### Windows Media Digital Rights Management/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Windows Calendar/\r### Windows Calendar/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Windows Update/\r### Windows Update/' './content/blog/cybersec/windows-setup/group-policies/index.md'
...
sed -i 's/# Cloud Content/\r### Cloud Content/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# File Explorer/\r### File Explorer/' './content/blog/cybersec/windows-setup/group-policies/index.md'
sed -i 's/# Windows Copilot/\r### Windows Copilot/' './content/blog/cybersec/windows-setup/group-policies/index.md'
...
echo 'authors: TommyTran732' >> './content/blog/cybersec/windows-setup/windows-settings/index.md'
